...
function caricaLuogoNascita(){
    ...
    var riga = caricaComuni(ricerca, 0);
...
function caricaResidenza(){
    ...
    var riga = caricaComuni(ricerca, 1);
    $("#elencoComuni2").html(riga);
    $("#elencoComuni2").show();
}

function caricaLuogoNascitaModifica(){
    var ricerca = $('#txtLuogoNascitaPopupPopupModificaPaziente').val();
    var riga = caricaComuni(ricerca, 2);
...
function caricaResidenzaModifica(){
    ...
    var riga = caricaComuni(ricerca, 3);
...
function initPopupModifica(){
    ...
    $.ajax({  
        ...
        success: function(response) {
            ...
            $('select option[value="' + datiPaziente.Motivo + '"]').attr("selected",true);
